...
public interface ICustomerController extends java.rmi.Remote {
	...
	// User defined annotation is placed to check user has CUSTOMER role or not
	...
	// customers purchase product
	@RequiresRole("CUSTOMER")
	List<itemList> custViewShoppingCart(Session session, String info) throws java.rmi.RemoteException;
