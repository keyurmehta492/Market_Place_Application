		...
		try {
			...
			if(fp.exists()) {
					...
					while(fdata!=null)
					{
						...
						if(Integer.parseInt(purchase[0]) == Integer.parseInt(temp[0])) {
							if (Integer.parseInt(purchase[1]) <= Integer.parseInt(temp[4])) {
		...
		try {
			...
			if(fp.exists()) {
					...
					while(fdata!=null)
					{
						...
						if(Integer.parseInt(purchase[0]) == Integer.parseInt(temp[0])) {
							if (Integer.parseInt(purchase[1]) <= Integer.parseInt(temp[4])) {
								newQuantity = Integer.parseInt(temp[4]) - Integer.parseInt(purchase[1]);
								newData = temp[0]+","+temp[1]+","+temp[2]+","+temp[3]+","
								+newQuantity+","+temp[5];
